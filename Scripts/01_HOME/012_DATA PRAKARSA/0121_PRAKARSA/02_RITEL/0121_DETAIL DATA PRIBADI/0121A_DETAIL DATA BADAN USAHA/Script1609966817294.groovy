...
CustomKeywords.'com.brispotritel.prakarsa.DetailDataPribadiBadanUsaha.DataPerusahaan'(npwp, status_badan_usaha, bentuk_badan_usaha, 
    gelar_badan_usaha, jenis_badan_usaha, nama_perusahaan, no_hp, email, fixed_line, fax, tempat_akta_awal, no_akta_awal, 
    no_akta_akhir, tanggal_debitur, tanggal_akta_awal, tanggal_akta_akhir)
...
CustomKeywords.'com.brispotritel.prakarsa.DetailDataPribadiBadanUsaha.Lainnya'(segmen_kredit, pendapatan_bulanan, omzet, 
    omzet_bulanan, transaksi_brinets, penghasilan, jenis_rekening, hub_bank_lain, nama_banklain, tujuan_buka_rekening)
