...
if (jenis_segmen_produk.equals('Ritel Komersial/Kecil')) {
    ...
    Mobile.tap(findTestObject('01_HOME/012_PRAKARSA/0121_PRAKARSA/01212_RITEL/01214_STATUS PRESCREENING/01214O_LAMPIRAN'), 
        GlobalVariable.timeOut)
    ...
    Mobile.tap(findTestObject('01_HOME/012_PRAKARSA/0121_PRAKARSA/01212_RITEL/01214_STATUS PRESCREENING/01214G_CLOSE'), 
        GlobalVariable.timeOut)
}
