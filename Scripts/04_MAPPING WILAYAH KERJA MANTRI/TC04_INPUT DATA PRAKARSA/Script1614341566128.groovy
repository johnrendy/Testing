...
Mobile.callTestCase(findTestCase('01_HOME/012_DATA PRAKARSA/0121_PRAKARSA/01_MIKRO/015 _SURVEY AGUNAN/0151_TAMBAH AGUNAN/0151C_SURVEY AGUNAN TANAH'), 
    [('DESKRIPSI') : deskripsi_atanah, ('KEPEMILIKAN') : kepemilikanagunan_atanah, ('PEMILIK') : atasnama_atanah, ('STATUSKEPEMILIKAN') : statuskepemilikan_atanah
...
Mobile.callTestCase(findTestCase('01_HOME/012_DATA PRAKARSA/0121_PRAKARSA/01_MIKRO/020_KIRIM PRAKARSA/020A_KIRIM PRAKASA'), 
    [('NAMALENGKAP') : nama_lengkap, ('KET') : keterangan_kirim_prakarsa], FailureHandling.STOP_ON_FAILURE)
